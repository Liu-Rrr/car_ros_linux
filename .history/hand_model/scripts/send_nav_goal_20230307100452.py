...
def sendOrigin():
    ...
    #   position:
    #     x: -2.3386390209198
    #     y: 0.3815002739429474
    #     z: 0.0
    #   orientation:
    #     x: 0.0
    #     y: 0.0
    #     z: 0.026031575718202752
    #     w: 0.9996611211133639

    # 观赏点
    ar_front_goal = point_goal(-0.11804591864347458,-0.27709510922431946,0.24434447042146976,0.969688496257665)
...
def send_goal():
    ...
    # ar_front_goal = point_goal(-0.0740973949432373,-0.572317361831665,0.15970077574167718,0.9871654685145275)
    # 比较稳的点
    # ar_front_goal = point_goal(-0.5162186622619629,-0.9578037261962891,0.11151927200549586,0.9937622713563663)
    ar_front_goal = point_goal(-0.3900492191314697,-0.22298219799995422,-0.9982062671887577,0.05986859063888556)
