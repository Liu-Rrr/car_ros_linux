...
canDLL = cdll.LoadLibrary('/home/info/catkin_ws/src/motor_drive/scripts/libcontrolcan.so')
...
while not rospy.is_shutdown():
   ...
   # print(x,y)
    ...
    cur_time0 = rospy.Time.now()
    odom_broadcaster.sendTransform((x,y,0.),odom_quat,cur_time0,"base_footprint","odom")
